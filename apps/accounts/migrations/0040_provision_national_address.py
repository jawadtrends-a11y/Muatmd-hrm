"""
دالّة التزويد تذكر حقول العنوان الوطنيّ (ق-111).

⚠️ الدرس نفسه للمرّة الثانية: `app_provision_account` تُنشئ الشركة
بـINSERT صريح الأعمدة، فكل عمود نصّيّ جديد لا يُذكر فيها يدخل NULL
ويصطدم بـNOT NULL — **فيسقط إنشاء أي حساب جديد**.

فأي حقل نصّيّ يُضاف إلى Company يلزمه تحديث هذه الدالّة معه.
"""
...
class Migration(migrations.Migration):
    dependencies = [("accounts", "0039_national_address")]
