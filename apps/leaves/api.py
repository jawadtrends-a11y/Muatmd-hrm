...
# ق-186: **حُذف `my_editable_fields`** (قرار جواد).
#
# ⚠️⚠️ **فحلّان لمسألةٍ واحدة يُربكان**: والموظف **يعدّل من ملفّه
# فيتحوّل التعديل طلبًا** — ولا يحتاج شاشةً ثانية.
#
# **و`EDITABLE_BY_EMPLOYEE` تبقى**: فهي **تحرس ما يُطلب تعديله** —
# وحذفُها يفتح الراتب والعقد.
