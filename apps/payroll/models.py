...
class PayrollSettings(CompanyScopedModel):
    ...
    # ق-138: **مخالصة الإجازة أثناء الخدمة**.
    #
    # ⚠️ صرف بدل الإجازة بلا استخدامٍ فعليّ ولا انتهاء علاقة
    # **مخالفٌ لنظام العمل** — والمسؤولية على صاحب العمل.
    #
    ...
    # لم يشأ فلا أنشطة لهم — فإلزامُ الجميع يُحيلها طقسًا فارغًا.
    activities_enabled = models.BooleanField(
        _("تمكين أنشطة العمل"), default=False)
