...
def test_every_business_table_has_rls():
    ...
    exempt = {
        ...
        "accounts_authtoken",
        # ق-113: التسجيل الذاتيّ واستعادة كلمة المرور — يقعان
        # **قبل وجود حساب** أو خارج جلسته، فلا account_id لهما
        # يُعزل به. والحماية بالرمز المجزَّأ (SHA-256) والمهلة
        # القصيرة، ولا يحويان بيانات عميل: بريدٌ واسم شركة قبل
        # إنشائها، وبصمة رمز لا الرمز نفسه.
